...
Description: Program that creates sales.txt if missing......allows user to add transactions......reads all transactions and calculates total sales for the day, and closes file properly.
*/
